...
Now that we have Sentry catching errors, let's move to [Debugging Issues](/debugging-issues/) where we'll learn how to actively instrument our code with try/catch blocks and Sentry's error capturing functions to get even more context about what's going wrong in our application. 